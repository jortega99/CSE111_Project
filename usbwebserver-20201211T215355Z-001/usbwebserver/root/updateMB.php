...
<nav class="topnav navbar-inverse">
  <div class="container-fluid">
	...
	<li   class="active"><a href="searchMB.php">Motherboards</a></li>
...
echo "<h3>New Motherboard saved to build</h3>";
$sql = "UPDATE build SET b_motherboard = (select MB_name from motherboard where MB_id = '$m_ID') where b_code = '$bcode'";
