...
INSERT INTO Build(b_cpu,b_gpu,b_motherboard,b_psu,b_storage,b_tower,b_ram)
SELECT CPU_name, GPU_name, MB_name,PSU_name,RAM_name,Storage_name,Case_name 
FROM CPU,GPU,MotherBoard,PSU,RAM,Storage,Tower 
WHERE CPU_id = 'CPU_02' AND GPU_id = 'GPU_01' AND MB_id = 'M_01' AND PSU_id = 'P_01' AND RAM_id = 'R_01' AND Storage_id = 'S_01' AND Case_id = 'C_01'

UPDATE Build
SET b_user = 'mlara'
WHERE b_user is NULL